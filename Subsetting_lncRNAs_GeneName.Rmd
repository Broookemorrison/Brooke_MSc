...
I dont think I actually needed all of this to subset oiut the lncRNAs - dragging just the import of the lncRNA file into subsetting_lncRNAs_by_cluster file and including that in progress report, not this.
...
```{r lncRNA expression}
# extract lncRNA names
lncRNA_gene_names <- lncRNAs$gene_name

# Subset Seurat objects by lncRNA names to make smaller seurat objects with just lncRNA expression info
seurat_spatialP1T2_lnc <- seurat_spatialP1T2[lncRNA_gene_names,]
seurat_spatialP2T2_lnc <- seurat_spatialP2T2[lncRNA_gene_names,]
seurat_spatialP2M_lnc <- seurat_spatialP2M[lncRNA_gene_names,]
```
...
all_less_sig_DE_lncRNAs
all_DE_lncRNAs
all_spatially_variable_lncRNAs
all_sig_spatially_variable_lncRNAs
